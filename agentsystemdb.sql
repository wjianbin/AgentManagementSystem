...
MySQL - 5.5.61 : Database - agentsystemdb
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`agentsystemdb` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
...
/*Data for the table `as_account` */

insert  into `as_account`(`id`,`userId`,`money`,`moneyBak`) values 
(1,2,302000,30000),
(36,3,41000,40000),
(37,4,0,0),
(38,6,0,0),
...
/*Table structure for table `as_accountdetail` */
...
CREATE TABLE `as_accountdetail` (
  ...
  `money` double NOT NULL DEFAULT '0',
  `accountMoney` double NOT NULL DEFAULT '0',
  `memo` char(255) DEFAULT NULL,
  `detailDateTime` datetime NOT NULL DEFAULT '2012-01-01 00:01:01',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=100 DEFAULT CHARSET=utf8;

/*Data for the table `as_accountdetail` */

insert  into `as_accountdetail`(`id`,`userId`,`detailType`,`detailTypeName`,`money`,`accountMoney`,`memo`,`detailDateTime`) values 
(79,2,3,'er',2,0,NULL,'2012-01-01 00:01:01'),
(80,3,4,'6',6,6,'78','2012-01-01 00:01:01'),
(81,2,7,'45',4,5,'6','2012-01-01 00:01:01'),
(82,4,4,'56',0,0,NULL,'2019-01-11 00:01:01'),
(83,13,4,'44',0,0,NULL,'2012-01-01 00:01:01'),
(84,2,4,'5',6,7,NULL,'2012-01-01 00:01:01'),
(85,7,6,'87',45,43,NULL,'2019-01-11 00:01:01'),
(86,11,45,'56',45,4,NULL,'2012-01-01 00:01:01'),
(87,12,33,'5',34,2,NULL,'2012-01-01 00:01:01'),
(88,2,4,'34',25,5,NULL,'2012-01-01 00:01:01'),
(89,14,23,'56',23,5,NULL,'2012-01-01 00:01:01'),
(90,2,34,'4',4,6,NULL,'2012-01-01 00:01:01'),
(91,2,9998,'系统自动返款冻结资金',30000,30000,'we预注册5天后过期，系统自动返款冻结资金','2019-01-04 00:01:01'),
(92,3,9998,'系统自动返款冻结资金',40000,40000,'rt预注册5天后过期，系统自动返款冻结资金','2019-01-04 00:01:01'),
(93,3,3,'财务打款',1000,41000,'first comment test 01','2019-01-09 15:31:27'),
(94,2,3,'财务打款',1000000,1030000,'KeywordsRenew save admin money 1000000 test','2019-01-11 11:04:56'),
(95,2,9996,'扣除关键词续费资金',130000,900000,'Id号：9996，名称：扣除关键词续费资金，充值金额：130000，userId：2，AsKeywordsID：1','2019-01-11 11:05:16'),
(96,2,9996,'扣除关键词续费资金',260000,640000,'Id号：9996，名称：扣除关键词续费资金，充值金额：260000，userId：2，AsKeywordsID：1','2019-01-11 11:05:29'),
(97,2,9996,'扣除关键词续费资金',130000,510000,'Id号：9996，名称：扣除关键词续费资金，充值金额：130000，userId：2，AsKeywordsID：1','2019-01-17 18:03:48'),
(98,2,9996,'扣除关键词续费资金',78000,432000,'Id号：9996，名称：扣除关键词续费资金，充值金额：78000，userId：2，AsKeywordsID：1','2019-01-17 18:09:07'),
(99,2,9996,'扣除关键词续费资金',130000,302000,'Id号：9996，名称：扣除关键词续费资金，充值金额：130000，userId：2，AsKeywordsID：1','2019-01-17 18:09:18');
...
insert  into `as_admin`(`id`,`username`) values 
(1,'admin123321');

/*Table structure for table `as_contacts` */
...
/*Data for the table `as_contacts` */

insert  into `as_contacts`(`id`,`customId`,`contactName`,`contactTel`,`contactFax`,`contactEmail`,`contactRole`) values 
(14,28,'qq','123','34','56','2'),
(15,29,'aa','234','45','556','1'),
(16,30,'bb','345','34','23','34'),
(17,31,'cc','345','34','65','45'),
(18,32,'dd','55','33','22','4'),
(19,33,'ff','44','22','11','7'),
(20,46,'3453245','3452334','53453245','345','32452345'),
(21,47,'12134','345','3456','456','546'),
(22,49,'ewr','234','435','435','234'),
(23,50,'qwerq','112','234','321','faf'),
(24,51,'sa','14','12','3245','254');

/*Table structure for table `as_customs` */
...
/*Data for the table `as_customs` */

insert  into `as_customs`(`id`,`agentId`,`agentName`,`customName`,`customType`,`customTypeName`,`siteUrl`,`customStatus`,`bossName`,`cardType`,`cardTypeName`,`cardNum`,`companyTel`,`companyFax`,`regDatetime`,`country`,`province`,`city`,`area`,`companyAddress`,`memo`,`agentCode`) values 
(28,1,'ee','bdqn',2,'个人','3',0,'3',1,'国内身份证','3','3','3','2012-01-01 00:01:01','中国','430000','431100','431127','3','','3'),
(29,1,'aa','ss',3,'个人','34',0,'45',45,'6','7','7','6','2012-01-01 00:01:01','中国','陕西省','西安市','雁塔区','6',NULL,'6'),
(30,2,'bb','dsg',0,'企业','4',1,'4',4,'4','4','4','4','2012-01-01 00:01:01','中国','0','0','0','4','','4'),
(31,3,'cc','cc',4,'企业','5',1,'5',5,'5','5','5','5','2012-01-01 00:01:01','中国','河南省','灵宝市','兰考县','5',NULL,'5'),
(32,4,'rr','rr',5,'企业','5',0,'5',5,'6','6','6','6','2012-01-01 00:01:01','中国','山西省','运城市','稷山县','6',NULL,'6'),
(33,5,'tt','ee',7,'个人','7',0,'7',7,'7','7','7','7','2012-01-01 00:01:01','中国','甘肃省','兰州市','安宁区','7',NULL,'7'),
(44,2,'系统管理员','123',1,'企业','123123',1,'123123',0,'','123123','123','1231223','2019-01-08 00:00:00','中国','0','0','0','123123','123',NULL),
(45,2,'系统管理员','sssssssssssss',1,'企业','32453245',1,'',0,'','','','','2019-01-08 00:00:00','中国','0','0','0','','',NULL),
(46,2,'系统管理员','2354',2,'个人','3453245',1,'',0,'','','','','2019-01-08 00:00:00','中国','0','0','0','','',NULL),
(47,2,'系统管理员','asdf',1,'企业','wfe',1,'wf',2,'境外身份证','345','345','2345','2019-01-08 00:00:00','中国','0','0','0','345','ret',NULL),
(48,2,'系统管理员','365345635',1,'企业','345663456',0,'34563456',0,'','43564356','43563456','34563456','2019-01-08 00:00:00','中国','130000','130400','130429','456456','43563456',NULL),
(49,2,'系统管理员','3456',1,'企业','wer',0,'wer',1,'国内身份证','123','3243','234','2019-01-08 00:00:00','中国','370000','371300','371326','dsf','wer',NULL),
(50,2,'系统管理员','eshasg',2,'个人','ssfga',1,'sagfa',1,'国内身份证','1223455','234','234','2019-01-16 00:00:00','中国','0','0','0','fqefqw','qreq',NULL),
(51,2,'系统管理员','admin',2,'个人','sdfga',1,'qqq',2,'境外身份证','2341','52','1234','2019-01-16 00:00:00','中国','0','0','0','erg','gasg',NULL);

/*Table structure for table `as_function` */
...
/*Data for the table `as_function` */

insert  into `as_function`(`id`,`functionCode`,`functionName`,`creationTime`,`createdBy`,`lastUpdateTime`,`funcUrl`,`isStart`,`parentId`) values 
(1,'keyword','关键词申请','2013-01-01 00:00:01','admin','2013-01-01 00:00:01','/keyword.action',1,5),
(2,'customlist','代理商客户管理','2013-01-01 00:00:01','admin','2013-01-01 00:00:01','/customlist.action',1,5),
(3,'yfk','代理商预付款','2013-10-12 00:00:00','admin','2013-01-01 00:00:01','/yfk.action',1,5),
(4,'keywordmanage','关键词申请管理','2013-10-12 00:00:00','admin','2013-01-01 00:00:01','/keywordmanage.action',1,5),
(5,'dlsmanage','代理商管理','2013-10-12 00:00:00','admin','2013-01-01 00:00:01','/main.action',1,0),
(6,'caiwu','财务管理','2013-10-12 00:00:00','admin','2013-01-01 00:00:01','/caiwu.action',1,20),
(7,'rolelist','角色管理','2013-10-12 00:00:00','admin','2013-01-01 00:00:01','/rolelist.action',1,20),
(8,'premission','角色权限配置','2013-10-12 00:00:00','admin','2013-01-01 00:00:01','/premission.action',1,20),
(9,'userlist','用户管理','2013-10-12 00:00:00','adimin','2013-01-01 00:00:01','/userlist.action',1,20),
(10,'caiwutype','财务类型','2013-10-12 00:00:00','admin','2013-01-01 00:00:01','/caiwutype.action',1,21),
(11,'servicetype','服务类型','2013-10-12 00:00:00','admin','2013-01-01 00:00:01','/servicetype.action',1,21),
(12,'serviceyears','服务年限','2013-10-12 00:00:00','admin','2013-01-01 00:00:01','/serviceyears.action',1,21),
(13,'appurl','APP地址','2013-10-12 00:00:00','admin','2013-01-01 00:00:01','/appurl.action',1,21),
(14,'customtype','客户类型','2013-10-12 00:00:00','admin','2013-01-01 00:00:01','/customtype.action',1,21),
(15,'cardtype','证件类型','2013-10-12 00:00:00','admin','2013-01-01 00:00:01','/cardtype.action',1,21),
(16,'youhuitype','优惠类型','2013-10-12 00:00:00','admin','2013-01-01 00:00:01','/youhuitype.action',1,21),
(18,'portalmanage','门户管理','2013-10-12 00:00:00','admin','2013-01-01 00:00:01','javascript:void();',1,0),
(19,'reportmanage','报表管理','2013-10-12 00:00:00','admin','2013-01-01 00:00:01','javascript:void();',1,0),
(20,'systemmanage','系统管理','2013-10-12 00:00:00','admin','2013-01-01 00:00:01','javascript:void();',1,0),
(21,'systemconfig','系统配置管理','2013-10-12 00:00:00','admin','2013-01-01 00:00:01','javascript:void();',1,0),
(23,'checkkeywords','关键词审核','2013-01-01 00:00:00','admin','2013-01-01 00:00:00','/checkkeyword.action',1,20),
(24,'portal','门户管理','2013-01-01 00:00:01','admin','2013-01-01 00:00:01','/myportalmanage.action',1,18),
(25,'report','报表管理','2013-10-15 00:00:00','admin','2013-10-15 00:00:00','/report.action',1,19);

/*Table structure for table `as_keywords` */
...
/*Data for the table `as_keywords` */

insert  into `as_keywords`(`id`,`keywordS`,`agentId`,`agentName`,`customId`,`customName`,`preRegFrozenMoney`,`price`,`productType`,`serviceYears`,`openApp`,`appUserName`,`appPassword`,`loginUrl`,`iosDownloadUrl`,`androidDownloadUrl`,`codeIosUrl`,`codeAndroidUrl`,`preRegDatetime`,`preRegPassDatetime`,`regDatetime`,`regPassDatetime`,`isPass`,`checkStatus`,`isUse`) values 
(1,'4',2,'4',28,'er',20000,130000,12,5,1,'qqqqq','111','34','eeee','12<<<<','der','78','2012-01-01 00:01:01','2012-01-01 00:01:01','2012-01-01 00:01:01','2040-01-01 00:01:01',0,2,1),
(20,'er',4,'7',29,'tr',50000,90000,12,0,1,'333','333','77','55','55','23','54','2012-01-01 00:01:01','2012-01-01 00:01:01','2012-01-01 00:01:01','2012-01-01 00:01:01',0,2,1),
(21,'df',5,'8',30,'uy',60000,55555,12,0,0,'333','333','66','66','13','34','35','2012-01-01 00:01:01','2012-01-01 00:01:01','2012-01-01 00:01:01','2012-01-01 00:01:01',0,2,1),
(22,'aa',6,'9',31,'op',70000,80000,12,0,1,'666','666','23','66','66','6','66','2012-01-01 00:01:01','2012-01-01 00:01:01','2012-01-01 00:01:01','2012-01-01 00:01:01',0,2,1),
(23,'cc',7,'6',32,'ud',80000,50000,13,0,1,'333','333','44','88','15','56','67','2012-01-01 00:01:01','2012-01-01 00:01:01','2012-01-01 00:01:01','2012-01-01 00:01:01',0,2,1),
(24,'ff',8,'7',33,'tr',90000,20000,13,0,1,'34','45','88','hh','hh','tt','rr','2012-01-01 00:01:01','2012-01-01 00:01:01','2012-01-01 00:01:01','2012-01-01 00:01:01',0,2,1),
(25,'java',2,'系统管理员',51,'admin',26000,26000,0,1,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2012-01-01 00:01:01','2012-01-01 00:01:01','2012-01-01 00:01:01','2012-01-01 00:01:01',2,0,1);

/*Table structure for table `as_logs` */
...
/*Data for the table `as_role` */

insert  into `as_role`(`id`,`roleName`,`creationTime`,`createdBy`,`lastUpdateTime`,`isStart`) values 
(1,'系统管理员','2013-10-04 00:00:00','admin','2013-10-12 21:32:43',1),
(40,'代理商','2013-10-12 10:29:57','admin',NULL,1),
(41,'财务','2013-10-12 10:30:18','admin',NULL,1),
(42,'客服','2013-10-12 10:30:26','admin',NULL,1),
(43,'市场','2013-10-12 10:30:50','admin',NULL,1),
(44,'大区经理','2013-10-12 10:31:44','admin',NULL,1);

/*Table structure for table `as_role_premission` */
...
/*Data for the table `as_role_premission` */

insert  into `as_role_premission`(`id`,`roleId`,`functionId`,`creationTime`,`createdBy`,`lastUpdateTime`,`isStart`) values 
(171,40,1,'2013-10-14 12:37:30','admin',NULL,1),
(172,40,2,'2013-10-14 12:37:30','admin',NULL,1),
(173,40,3,'2013-10-14 12:37:30','admin',NULL,1),
(174,40,4,'2013-10-14 12:37:30','admin',NULL,1),
(175,40,22,'2013-10-14 12:37:30','admin',NULL,1),
(176,40,24,'2013-10-14 12:37:30','admin',NULL,1),
(195,1,1,'2013-10-15 14:30:58','admin',NULL,1),
(196,1,2,'2013-10-15 14:30:58','admin',NULL,1),
(197,1,3,'2013-10-15 14:30:58','admin',NULL,1),
(198,1,4,'2013-10-15 14:30:58','admin',NULL,1),
(199,1,6,'2013-10-15 14:30:58','admin',NULL,1),
(200,1,7,'2013-10-15 14:30:58','admin',NULL,1),
(201,1,8,'2013-10-15 14:30:58','admin',NULL,1),
(202,1,9,'2013-10-15 14:30:58','admin',NULL,1),
(203,1,10,'2013-10-15 14:30:58','admin',NULL,1),
(204,1,11,'2013-10-15 14:30:58','admin',NULL,1),
(205,1,12,'2013-10-15 14:30:58','admin',NULL,1),
(206,1,13,'2013-10-15 14:30:58','admin',NULL,1),
(207,1,14,'2013-10-15 14:30:58','admin',NULL,1),
(208,1,15,'2013-10-15 14:30:58','admin',NULL,1),
(209,1,16,'2013-10-15 14:30:58','admin',NULL,1),
(210,1,22,'2013-10-15 14:30:58','admin',NULL,1),
(211,1,23,'2013-10-15 14:30:58','admin',NULL,1),
(212,1,24,'2013-10-15 14:30:58','admin',NULL,1),
(213,1,25,'2013-10-15 14:30:58','admin',NULL,1),
(214,41,6,'2013-10-18 13:47:14','admin',NULL,1),
(215,41,25,'2013-10-18 13:47:14','admin',NULL,1),
(220,44,25,'2013-10-21 09:24:04','admin',NULL,1),
(221,42,6,'2014-05-08 13:38:35','admin',NULL,1),
(222,42,7,'2014-05-08 13:38:35','admin',NULL,1),
(223,42,8,'2014-05-08 13:38:35','admin',NULL,1),
(224,42,9,'2014-05-08 13:38:35','admin',NULL,1),
(225,42,23,'2014-05-08 13:38:35','admin',NULL,1),
(226,42,25,'2014-05-08 13:38:35','admin',NULL,1),
(227,45,25,'2014-05-08 13:45:47','admin',NULL,1),
(228,43,25,'2014-05-08 13:45:55','admin',NULL,1);

/*Table structure for table `as_siteconfig` */
...
/*Data for the table `as_siteconfig` */

insert  into `as_siteconfig`(`siteName`) values 
('AgentSystem后台管理系统');

/*Table structure for table `as_systemconfig` */
...
CREATE TABLE `as_systemconfig` (
  ...
  `configTypeName` varchar(20) DEFAULT NULL,
...
/*Data for the table `as_systemconfig` */

insert  into `as_systemconfig`(`id`,`configType`,`configTypeName`,`configTypeValue`,`configValue`,`isStart`) values 
(2,1,'账号',2,NULL,1),
(3,1,'财务打款',3,NULL,1),
(4,1,'冻结',4,NULL,1),
(5,1,'扣费',5,NULL,1),
(6,1,'代理款冲抵',6,NULL,1),
(12,2,'上传苹果商城',1,'26000',1),
(13,2,'不上传苹果商城',2,'18000',1),
(14,3,'服务年限',1,'2',1),
(15,4,'APP系统地址',1,'http://app.bdqn.com',1),
(16,5,'企业',1,NULL,1),
(17,5,'个人',2,NULL,1),
(18,5,'政府',3,NULL,1),
(19,6,'国内身份证',1,NULL,1),
...
CREATE TABLE `as_user` (
  ...
  `creationTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '注册时间',
...
/*Data for the table `as_user` */

insert  into `as_user`(`id`,`userCode`,`userName`,`userPassword`,`creationTime`,`lastLoginTime`,`createdBy`,`lastUpdateTime`,`isStart`,`roleId`) values 
(2,'admin','系统管理员','e10adc3949ba59abbe56e057f20f883e','2013-10-03 00:00:00','2014-05-14 13:11:34','admin','2013-01-01 00:00:01',1,1),
(3,'CW_1','财务测试用户1','e10adc3949ba59abbe56e057f20f883e','2013-10-11 11:42:40','2013-10-18 13:53:44','admin','2013-10-12 11:43:37',1,41),
(4,'DLS_2','代理商用户1','e10adc3949ba59abbe56e057f20f883e','2013-10-11 11:50:02',NULL,'admin','2013-10-12 11:42:40',1,40),
(6,'DQ_1','代理商用户2','e10adc3949ba59abbe56e057f20f883e','2013-10-11 13:27:23',NULL,'admin','2013-10-12 11:44:41',1,40),
(7,'CW_3','代理商用户3','e10adc3949ba59abbe56e057f20f883e','2013-10-11 13:27:34',NULL,'admin','2013-10-12 11:44:10',1,40),
(11,'DQ_2','代理商用户4','e10adc3949ba59abbe56e057f20f883e','2013-10-12 11:45:06',NULL,'admin','2013-10-12 11:45:06',1,40),
(12,'SC_1','代理商用户5','e10adc3949ba59abbe56e057f20f883e','2013-10-12 11:45:41',NULL,'admin','2013-10-12 11:45:41',1,40),
(13,'SC_2','市场测试用户2','e10adc3949ba59abbe56e057f20f883e','2013-10-12 11:45:53',NULL,'admin','2013-10-12 11:45:53',1,43),
(14,'QD_1','渠道测试用户1','e10adc3949ba59abbe56e057f20f883e','2013-10-12 11:46:13',NULL,'admin','2013-10-12 11:46:13',1,45),
(15,'QD_2','渠道测试用户2','e10adc3949ba59abbe56e057f20f883e','2013-10-12 11:46:28',NULL,'admin','2013-10-12 11:46:28',1,45),
(16,'DLS_1','代理商用户6','e10adc3949ba59abbe56e057f20f883e','2013-10-14 10:34:48','2013-10-31 17:16:07','admin','2013-10-14 10:34:48',1,40),
(18,'aa','市场测试用户7','e10adc3949ba59abbe56e057f20f883e','2019-01-09 17:49:59','2013-01-01 00:00:01','admin','2013-01-01 00:00:01',1,1),
(19,'ac','代理商用户7','e10adc3949ba59abbe56e057f20f883e','2019-01-09 17:51:58','2013-01-01 00:00:01','admin','2019-01-09 20:34:44',1,40);
...
/*Table structure for table `hat_city` */
...
/*Table structure for table `hat_province` */
...
/*Data for the table `hat_province` */
...
/* Event structure for event `FiveDaysPassKeywords` */

/*!50106 DROP EVENT IF EXISTS `FiveDaysPassKeywords`*/;

DELIMITER $$

/*!50106 CREATE DEFINER=`root`@`localhost` EVENT `FiveDaysPassKeywords` ON SCHEDULE EVERY 1 DAY STARTS '2013-10-15 00:01:01' ON COMPLETION NOT PRESERVE ENABLE DO CALL keywordPassFiveDays */$$
DELIMITER ;

/* Procedure structure for procedure `keywordPassFiveDays` */

/*!50003 DROP PROCEDURE IF EXISTS  `keywordPassFiveDays` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`%` PROCEDURE `keywordPassFiveDays`()
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`%` PROCEDURE `test1`()
BEGIN
...
/*Table structure for table `as_account_all` */

DROP TABLE IF EXISTS `as_account_all`;

/*!50001 DROP VIEW IF EXISTS `as_account_all` */;
/*!50001 DROP TABLE IF EXISTS `as_account_all` */;

/*!50001 CREATE TABLE  `as_account_all`(
 `userCode` varchar(50) ,
...
/*Table structure for table `as_accountdetail_all` */

DROP TABLE IF EXISTS `as_accountdetail_all`;

/*!50001 DROP VIEW IF EXISTS `as_accountdetail_all` */;
/*!50001 DROP TABLE IF EXISTS `as_accountdetail_all` */;

/*!50001 CREATE TABLE  `as_accountdetail_all`(
 `lastLoginTime` datetime ,
 `userId` bigint(20) unsigned ,
 `detailType` bigint(20) unsigned ,
...
/*Table structure for table `as_customs_all` */

DROP TABLE IF EXISTS `as_customs_all`;

/*!50001 DROP VIEW IF EXISTS `as_customs_all` */;
/*!50001 DROP TABLE IF EXISTS `as_customs_all` */;

/*!50001 CREATE TABLE  `as_customs_all`(
 `id` bigint(20) unsigned ,
 `agentId` bigint(20) ,
 `agentName` varchar(255) ,
 `customName` varchar(255) ,
 `customType` int(11) ,
 `customTypeName` varchar(50) ,
 `siteUrl` varchar(255) ,
 `customStatus` int(11) ,
 `bossName` varchar(50) ,
 `cardType` int(11) ,
...
/*Table structure for table `priducts` */

DROP TABLE IF EXISTS `priducts`;

/*!50001 DROP VIEW IF EXISTS `priducts` */;
/*!50001 DROP TABLE IF EXISTS `priducts` */;

/*!50001 CREATE TABLE  `priducts`(
 `id` bigint(20) unsigned ,
 `configType` int(11) ,
 `configTypeName` varchar(20) ,
 `configTypeValue` int(11) ,
 ...
 `customId` bigint(20) ,
 `customName` varchar(255) ,
 `preRegFrozenMoney` double ,
 `price` double ,
 `productType` int(11) ,
 `serviceYears` int(11) ,
 `openApp` int(11) ,
 `appUserName` varchar(64) ,
 `appPassword` varchar(70) ,
 `loginUrl` varchar(255) ,
 `iosDownloadUrl` varchar(255) ,
 `androidDownloadUrl` varchar(255) ,
 `codeIosUrl` varchar(255) ,
 `codeAndroidUrl` varchar(255) ,
 `preRegDatetime` datetime ,
 `preRegPassDatetime` datetime ,
 `regDatetime` datetime ,
 `regPassDatetime` datetime ,
 `isPass` int(11) ,
 `checkStatus` int(11) ,
 `isUse` int(11) 
)*/;

/*Table structure for table `procteds` */

DROP TABLE IF EXISTS `procteds`;

/*!50001 DROP VIEW IF EXISTS `procteds` */;
/*!50001 DROP TABLE IF EXISTS `procteds` */;

/*!50001 CREATE TABLE  `procteds`(
 `configTypeName` varchar(20) ,
 `number` bigint(21) ,
 `price` double 
)*/;
...
/*!50001 DROP VIEW IF EXISTS `userr` */;
/*!50001 DROP TABLE IF EXISTS `userr` */;

/*!50001 CREATE TABLE  `userr`(
 `id` bigint(20) unsigned ,
 `userCode` varchar(50) ,
 `userName` varchar(100) ,
 `userPassword` varchar(64) ,
...
/*Table structure for table `viewcustoms` */

DROP TABLE IF EXISTS `viewcustoms`;

/*!50001 DROP VIEW IF EXISTS `viewcustoms` */;
/*!50001 DROP TABLE IF EXISTS `viewcustoms` */;

/*!50001 CREATE TABLE  `viewcustoms`(
 `id` bigint(20) unsigned ,
 `agentId` bigint(20) ,
 `agentName` varchar(255) ,
 `customName` varchar(255) ,
 ...
 `contactRole` varchar(20) ,
 `acid` bigint(20) unsigned ,
 `cityID` varchar(6) ,
 `city` varchar(50) ,
 `areaID` varchar(50) ,
 `area` varchar(60) ,
...
/*View structure for view as_account_all */

/*!50001 DROP TABLE IF EXISTS `as_account_all` */;
/*!50001 DROP VIEW IF EXISTS `as_account_all` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `as_account_all` AS select `as_user`.`userCode` AS `userCode`,`as_user`.`id` AS `id`,`as_user`.`userName` AS `userName`,`as_user`.`userPassword` AS `userPassword`,`as_user`.`creationTime` AS `creationTime`,`as_user`.`lastLoginTime` AS `lastLoginTime`,`as_user`.`createdBy` AS `createdBy`,`as_user`.`lastUpdateTime` AS `lastUpdateTime`,`as_user`.`isStart` AS `isStart`,`as_user`.`roleId` AS `roleId`,`as_account`.`userId` AS `userId`,`as_account`.`money` AS `money`,`as_account`.`moneyBak` AS `moneyBak` from (`as_account` join `as_user` on((`as_account`.`userId` = `as_user`.`id`))) */;

/*View structure for view as_accountdetail_all */

/*!50001 DROP TABLE IF EXISTS `as_accountdetail_all` */;
/*!50001 DROP VIEW IF EXISTS `as_accountdetail_all` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `as_accountdetail_all` AS select `as_user`.`lastLoginTime` AS `lastLoginTime`,`as_accountdetail`.`userId` AS `userId`,`as_accountdetail`.`detailType` AS `detailType`,`as_accountdetail`.`detailTypeName` AS `detailTypeName`,`as_accountdetail`.`money` AS `money`,`as_accountdetail`.`accountMoney` AS `accountMoney`,`as_accountdetail`.`memo` AS `memo`,`as_accountdetail`.`detailDateTime` AS `detailDateTime`,`as_user`.`id` AS `id`,`as_user`.`userCode` AS `userCode`,`as_user`.`userName` AS `userName`,`as_user`.`userPassword` AS `userPassword`,`as_user`.`creationTime` AS `creationTime`,`as_user`.`createdBy` AS `createdBy`,`as_user`.`lastUpdateTime` AS `lastUpdateTime`,`as_user`.`isStart` AS `isStart`,`as_user`.`roleId` AS `roleId` from (`as_user` join `as_accountdetail` on((`as_accountdetail`.`userId` = `as_user`.`id`))) */;

/*View structure for view as_customs_all */

/*!50001 DROP TABLE IF EXISTS `as_customs_all` */;
/*!50001 DROP VIEW IF EXISTS `as_customs_all` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `as_customs_all` AS select `as_customs`.`id` AS `id`,`as_customs`.`agentId` AS `agentId`,`as_customs`.`agentName` AS `agentName`,`as_customs`.`customName` AS `customName`,`as_customs`.`customType` AS `customType`,`as_customs`.`customTypeName` AS `customTypeName`,`as_customs`.`siteUrl` AS `siteUrl`,`as_customs`.`customStatus` AS `customStatus`,`as_customs`.`bossName` AS `bossName`,`as_customs`.`cardType` AS `cardType`,`as_customs`.`cardTypeName` AS `cardTypeName`,`as_customs`.`cardNum` AS `cardNum`,`as_customs`.`companyTel` AS `companyTel`,`as_customs`.`companyFax` AS `companyFax`,`as_customs`.`regDatetime` AS `regDatetime`,`as_customs`.`country` AS `country`,`as_customs`.`province` AS `province`,`as_customs`.`city` AS `city`,`as_customs`.`area` AS `area`,`as_customs`.`companyAddress` AS `companyAddress`,`as_customs`.`memo` AS `memo`,`as_customs`.`agentCode` AS `agentCode`,`as_keywords`.`keywordS` AS `keywordS`,`as_keywords`.`customId` AS `customId`,`as_keywords`.`isUse` AS `isUse` from (`as_customs` join `as_keywords` on((`as_customs`.`id` = `as_keywords`.`customId`))) */;

/*View structure for view priducts */

/*!50001 DROP TABLE IF EXISTS `priducts` */;
/*!50001 DROP VIEW IF EXISTS `priducts` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `priducts` AS select `as_systemconfig`.`id` AS `id`,`as_systemconfig`.`configType` AS `configType`,`as_systemconfig`.`configTypeName` AS `configTypeName`,`as_systemconfig`.`configTypeValue` AS `configTypeValue`,`as_systemconfig`.`configValue` AS `configValue`,`as_systemconfig`.`isStart` AS `isStart`,`as_keywords`.`keywordS` AS `keywordS`,`as_keywords`.`agentId` AS `agentId`,`as_keywords`.`agentName` AS `agentName`,`as_keywords`.`customId` AS `customId`,`as_keywords`.`customName` AS `customName`,`as_keywords`.`preRegFrozenMoney` AS `preRegFrozenMoney`,`as_keywords`.`price` AS `price`,`as_keywords`.`productType` AS `productType`,`as_keywords`.`serviceYears` AS `serviceYears`,`as_keywords`.`openApp` AS `openApp`,`as_keywords`.`appUserName` AS `appUserName`,`as_keywords`.`appPassword` AS `appPassword`,`as_keywords`.`loginUrl` AS `loginUrl`,`as_keywords`.`iosDownloadUrl` AS `iosDownloadUrl`,`as_keywords`.`androidDownloadUrl` AS `androidDownloadUrl`,`as_keywords`.`codeIosUrl` AS `codeIosUrl`,`as_keywords`.`codeAndroidUrl` AS `codeAndroidUrl`,`as_keywords`.`preRegDatetime` AS `preRegDatetime`,`as_keywords`.`preRegPassDatetime` AS `preRegPassDatetime`,`as_keywords`.`regDatetime` AS `regDatetime`,`as_keywords`.`regPassDatetime` AS `regPassDatetime`,`as_keywords`.`isPass` AS `isPass`,`as_keywords`.`checkStatus` AS `checkStatus`,`as_keywords`.`isUse` AS `isUse` from (`as_systemconfig` join `as_keywords` on((`as_keywords`.`productType` = `as_systemconfig`.`id`))) */;

/*View structure for view procteds */

/*!50001 DROP TABLE IF EXISTS `procteds` */;
/*!50001 DROP VIEW IF EXISTS `procteds` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `procteds` AS (select `systemconfig`.`configTypeName` AS `configTypeName`,count(1) AS `number`,sum(`keywords`.`price`) AS `price` from (`as_keywords` `keywords` join `as_systemconfig` `systemconfig`) where ((`keywords`.`productType` = `systemconfig`.`id`) and (`keywords`.`isUse` = 1) and (`keywords`.`checkStatus` = 2) and (`systemconfig`.`configType` = 2)) group by `systemconfig`.`id`) */;

/*View structure for view userr */

/*!50001 DROP TABLE IF EXISTS `userr` */;
/*!50001 DROP VIEW IF EXISTS `userr` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `userr` AS select `as_user`.`id` AS `id`,`as_user`.`userCode` AS `userCode`,`as_user`.`userName` AS `userName`,`as_user`.`userPassword` AS `userPassword`,`as_user`.`creationTime` AS `creationTime`,`as_user`.`lastLoginTime` AS `lastLoginTime`,`as_user`.`createdBy` AS `createdBy`,`as_user`.`lastUpdateTime` AS `lastUpdateTime`,`as_user`.`isStart` AS `isStart`,`as_user`.`roleId` AS `roleId`,`as_role`.`roleName` AS `roleName` from (`as_role` join `as_user` on((`as_user`.`roleId` = `as_role`.`id`))) */;

/*View structure for view viewcustoms */

/*!50001 DROP TABLE IF EXISTS `viewcustoms` */;
/*!50001 DROP VIEW IF EXISTS `viewcustoms` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewcustoms` AS (select `as_customs`.`id` AS `id`,`as_customs`.`agentId` AS `agentId`,`as_customs`.`agentName` AS `agentName`,`as_customs`.`customName` AS `customName`,`as_customs`.`customType` AS `customType`,`as_customs`.`customTypeName` AS `customTypeName`,`as_customs`.`siteUrl` AS `siteUrl`,`as_customs`.`customStatus` AS `customStatus`,`as_customs`.`bossName` AS `bossName`,`as_customs`.`cardType` AS `cardType`,`as_customs`.`cardTypeName` AS `cardTypeName`,`as_customs`.`cardNum` AS `cardNum`,`as_customs`.`companyTel` AS `companyTel`,`as_customs`.`companyFax` AS `companyFax`,`as_customs`.`regDatetime` AS `regDatetime`,`as_customs`.`country` AS `country`,`as_customs`.`companyAddress` AS `companyAddress`,`as_customs`.`memo` AS `memo`,`as_customs`.`agentCode` AS `agentCode`,`as_contacts`.`customId` AS `customId`,`as_contacts`.`contactName` AS `contactName`,`as_contacts`.`contactTel` AS `contactTel`,`as_contacts`.`contactFax` AS `contactFax`,`as_contacts`.`contactEmail` AS `contactEmail`,`as_contacts`.`contactRole` AS `contactRole`,`as_contacts`.`id` AS `acid`,`hat_city`.`cityID` AS `cityID`,`hat_city`.`city` AS `city`,`hat_area`.`areaID` AS `areaID`,`hat_area`.`area` AS `area`,`hat_province`.`provinceID` AS `provinceID`,`hat_province`.`province` AS `province` from ((((`as_customs` left join `as_contacts` on((`as_customs`.`id` = `as_contacts`.`customId`))) left join `hat_area` on((`as_customs`.`area` = `hat_area`.`areaID`))) left join `hat_city` on((`as_customs`.`city` = `hat_city`.`cityID`))) left join `hat_province` on('as_customs`.`province` = `hat_province`.`provinceID'))) */;
