...
$().ready(function(){
	...
	$("#selectprovince").change(function(){
		...
		$.post("/loadcity.action",{'provinceID':s_province},function(result){
	...
	$("#selectcity").change(function(){
		...
		$.post("/loadarea.action",{'cityID':s_city},function(result){
			if(result != ""){
				for(var i=0;i<result.length;i++){
	...
	function checksave(){
		...
		$.post("/isExitCustomName",{'id':id,'customName':custom_name},function(result){
